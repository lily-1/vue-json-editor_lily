    ...
    <div class="json-view-main">
        <div class="block_content">
          ...
          <span class="json-key">
            ...
            /> -->
            <span class="on_key" :title='item.name'>{{item.name.split(",")[1]}}</span>
            <i
                ...
                >
                  ...
                  <option :value="false">false</option>
                    ...
                    <div class="tools">
                        ...
                        <i class="del-btn" @click="addItemList(parsedData, item, index)" v-if='item.type =="array"'>
                            <i class="v-json-edit-icon-add"></i>
                        </i>
                        <i class="del-btn" @click="delItem(parsedData, item, index)" v-else-if='item.type =="object"'>
                            <i class="v-json-edit-icon-huishouzhan_huaban"></i>
                        </i>
                        <i class="del-btn" style='width: 20px; display: inline-block;' v-else></i>
                    </div>
                </div>
            </draggable>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            addItemList(parsedData, item, index) {
                console.dir(parsedData)
                console.dir(item)
                console.dir(index)
                item.childParams.push(item.childParams[0])
            },
